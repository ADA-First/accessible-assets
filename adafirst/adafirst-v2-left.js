...
}( window, ( function ()
{
  ...
  }( [ function ( e, t, i )
  {
    ...
    let n = document.body || document.getElementsByTagName( 'body' )[ 0 ],
      ...
      o = {
        jsonToHtml: ( e, t ) =>
        {
          ...
          {
            let s = null;
            s = '#text' == e.children[ n ].type ? 0 == e.children[ n ].text.indexOf( '#' ) ? document.createTextNode( t[ e.children[ n ].text.substring( 1 ) ] ) : document.createTextNode( e.children[ n ].text ) : o.jsonToHtml( e.children[ n ], t ),
              ( s && s.tagName && 'undefined' !== s.tagName.toLowerCase() || 3 == s.nodeType ) && i.appendChild( s )
          }
          return i
        },
        injectStyle: ( e, t = {} ) =>
        ...
        injectIconsCss()
        {
          ...
          t.type = 'text/css',
            t.rel = 'stylesheet',
            t.href = 'https://fonts.googleapis.com/icon?family=Material+Icons',
    ...
    class u
    {
      ...
      {
        return e.icon && e.icon.position && ( e.icon.position.left && ( delete r.icon.position.right, r.icon.position.left = e.icon.position.left ), e.icon.position.top && ( delete r.icon.position.bottom, r.icon.position.top = e.icon.position.top ) ),
          e
      }
      disabledUnsupportedFeatures()
      {
        'webkitSpeechRecognition' in window && 'https:' == location.protocol || ( a.warn( 'speech to text isn\'t supported in this brouser or in http protocol (https required)' ), this.options.modules.speechToText = !1 ),
          window.SpeechSynthesisUtterance && window.speechSynthesis || ( a.warn( 'text to speech isn\'t supported in this brouser' ), this.options.modules.textToSpeech = !1 ),
      ...
      injectIcon()
      {
        ...
        let s = '_adafirst-icon material-icons _adafirst' + ( this.options.icon.circular ? ' circular' : '' ),
          o = a.jsonToHtml(
          {
            type: 'i',
            attrs:
      ...
      injectMenu()
      {
        let e = a.jsonToHtml(
        {
          ...
          attrs:
          {
            class: '_adafirst-menu close _adafirst'
          },
          children: [
          {
            type: 'h3',
          ...
          },
          {
            ...
            children: [
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'increaseText'
              },
              children: [
              {
                type: '#text',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'decreaseText'
              },
              children: [
              {
                type: '#text',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'increaseTextSpacing'
              },
              children: [
              {
                type: '#text',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'decreaseTextSpacing'
              },
              children: [
              {
                type: '#text',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'invertColors',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'underlineLinks',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'bigCursor',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'readingGuide',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'textToSpeech'
              },
              children: [
              {
                type: '#text',
            ...
            },
            {
              ...
              attrs:
              {
                'data-adafirst-action': 'speechToText'
              },
              children: [
              {
                type: '#text',
          ...
          },
          {
            ...
            attrs:
            {
              class: 'adafirst-credit-link-external'
            },
            children: [
            {
              type: 'a',
        ...
        return this.body.appendChild( e ),
          ...
          document.querySelector( '._adafirst-menu ._menu-close-btn' ).addEventListener( 'click', () =>
          {
            this.toggleMenu()
          }, !1 ),
          document.querySelector( '._adafirst-menu ._menu-reset-btn' ).addEventListener( 'click', () =>
          {
            this.resetAll()
          }, !1 ),
          e
      ...
      addListeners()
      {
        ...
        for ( let t = 0; t < e.length; t++ ) e[ t ].addEventListener( 'click', e =>
        {
          ...
          this.invoke( t.target.getAttribute( 'data-adafirst-action' ) )
        }, !1 )
      }
      disableUnsupportedModules()
      {
        for ( let e in this.options.modules )
          ...
          {
            let t = document.querySelector( 'li[data-adafirst-action="' + e + '"]' );
      ...
      resetTextSize()
      {
        ...
        for ( let t = 0; t < e.length; t++ ) e[ t ].style.fontSize = e[ t ].getAttribute( 'data-init-font-size' ),
      ...
      resetTextSpace()
      {
        ...
        for ( let t = 0; t < e.length; t++ ) e[ t ].style.wordSpacing = e[ t ].getAttribute( 'data-init-word-spacing' ),
          e[ t ].removeAttribute( 'data-init-word-spacing' );
        for ( let i = 0; i < t.length; i++ ) e[ i ].style.letterSpacing = e[ i ].getAttribute( 'data-init-letter-spacing' ),
      ...
      alterTextSize( e )
      {
        ...
        {
          let e = document.querySelectorAll( '*:not(._adafirst)' );
          ...
          this.menuInterface = {
            ...
            invertColors: e =>
            {
              if ( console.log( e ), this.sessionState.invertColors = void 0 === e, this.onChange( !0 ), void 0 === this.initialValues.html.backgroundColor && ( this.initialValues.html.backgroundColor = getComputedStyle( this.html ).backgroundColor ), void 0 === this.initialValues.html.color && ( this.initialValues.html.color = getComputedStyle( this.html ).color ), e ) return this.resetIfDefined( this.initialValues.html.backgroundColor, this.html.style, 'backgroundColor' ),
                ...
                document.querySelector( '._adafirst-menu [data-adafirst-action="invertColors"]' ).classList.remove( 'active' ),
                this.initialValues.invertColors = !1,
                void( this.html.style.filter = '' );
              document.querySelector( '._adafirst-menu [data-adafirst-action="invertColors"]' ).classList.toggle( 'active' ),
            ...
            grayHues: e =>
            {
              ...
              let t;
              document.querySelector( '._adafirst-menu [data-adafirst-action="grayHues"]' ).classList.toggle( 'active' ),
            ...
            underlineLinks: e =>
            {
              ...
              if ( e ) return this.initialValues.underlineLinks = !1,
                document.querySelector( '._adafirst-menu [data-adafirst-action="underlineLinks"]' ).classList.remove( 'active' ),
                i();
              if ( document.querySelector( '._adafirst-menu [data-adafirst-action="underlineLinks"]' ).classList.toggle( 'active' ), this.initialValues.underlineLinks = !this.initialValues.underlineLinks, this.initialValues.underlineLinks )
              {
            ...
            bigCursor: e =>
            {
              if ( this.sessionState.bigCursor = void 0 === e, this.onChange( !0 ), e ) return this.html.classList.remove( '_adafirst_cursor' ),
                document.querySelector( '._adafirst-menu [data-adafirst-action="bigCursor"]' ).classList.remove( 'active' ),
                void( this.initialValues.bigCursor = !1 );
              document.querySelector( '._adafirst-menu [data-adafirst-action="bigCursor"]' ).classList.toggle( 'active' ),
                this.initialValues.bigCursor = !this.initialValues.bigCursor,
                this.html.classList.toggle( '_adafirst_cursor' )
            },
            readingGuide: e =>
            {
              if ( this.sessionState.readingGuide = void 0 === e, this.onChange( !0 ), e ) return null != document.getElementById( 'access_read_guide_bar' ) && document.getElementById( 'access_read_guide_bar' ).remove(),
                document.querySelector( '._adafirst-menu [data-adafirst-action="readingGuide"]' ).classList.remove( 'active' ),
                this.initialValues.readingGuide = !1,
                void( document.body.onmousemove = null );
              if ( document.querySelector( '._adafirst-menu [data-adafirst-action="readingGuide"]' ).classList.toggle( 'active' ), this.initialValues.readingGuide = !this.initialValues.readingGuide, this.initialValues.readingGuide )
              {
              ...
              else null != document.getElementById( 'access_read_guide_bar' ) && document.getElementById( 'access_read_guide_bar' ).remove(),
            ...
            textToSpeech: e =>
            {
              ...
              if ( e ) return document.querySelector( '._adafirst-menu [data-adafirst-action="textToSpeech"]' ).classList.remove( 'active' ),
                this.initialValues.textToSpeech = !1,
                i();
              if ( document.querySelector( '._adafirst-menu [data-adafirst-action="textToSpeech"]' ).classList.toggle( 'active' ), this.initialValues.textToSpeech = !this.initialValues.textToSpeech, this.initialValues.textToSpeech )
              {
            ...
            speechToText: e =>
            {
              ...
              let t = '_adafirst-speech-to-text',
                i = () =>
                {
                  ...
                  for ( let e = 0; e < i.length; e++ ) i[ e ].removeEventListener( 'focus', this.listen, !1 ),
                    i[ e ].classList.remove( '_adafirst-mic' )
                };
              if ( e ) return document.querySelector( '._adafirst-menu [data-adafirst-action="speechToText"]' ).classList.remove( 'active' ),
                this.initialValues.speechToText = !1,
                i();
              if ( document.querySelector( '._adafirst-menu [data-adafirst-action="speechToText"]' ).classList.toggle( 'active' ), this.initialValues.speechToText = !this.initialValues.speechToText, this.initialValues.speechToText )
              {
      ...
      saveSession()
      {
        c.set( '_adafirstState', this.sessionState )
      }
      setSessionFromCache()
      {
        let e = c.get( '_adafirstState' );
        if ( e )
        {
          if ( e.textSize )
          {
